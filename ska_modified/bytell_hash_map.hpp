...
namespace ska_modified
{

namespace detailv8
{
using ska_modified::detailv3::functor_storage;
using ska_modified::detailv3::KeyOrValueHasher;
using ska_modified::detailv3::KeyOrValueEquality;
using ska_modified::detailv3::AssignIfTrue;
using ska_modified::detailv3::HashPolicySelector;
...
template<typename K, typename K_S, typename V, typename H = std::hash<K>, typename E = std::equal_to<K>, typename A = std::allocator<std::pair<K, V> > >
class bytell_hash_map
        ...
        <
            ...
            K,
            H,
            detailv8::KeyOrValueHasher<K, std::pair<K_S, V>, H>,
            E,
            detailv8::KeyOrValueEquality<K, std::pair<K_S, V>, E>,
            A,
...
template<typename T, typename T_S, typename H = std::hash<T>, typename E = std::equal_to<T>, typename A = std::allocator<T> >
